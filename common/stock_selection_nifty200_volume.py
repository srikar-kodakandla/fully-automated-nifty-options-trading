...
for k in range(20,0,-1):
    ...
    sleep(10)
    try:
        sentiment=WebDriverWait(driver,0.1).until(EC.presence_of_element_located((By.XPATH,f'//*[@id="DataTables_Table_0"]/tbody/tr[1]/td[5]/span/b'))).text[:-1]
        sentiment=float(sentiment)
        if sentiment<0:
            print('clicked ... ')
        
            for i in range(1):
                WebDriverWait(driver,10).until(EC.presence_of_element_located((By.XPATH,f'/html/body/div[2]/div[2]/div[2]/div/div/div/div[2]/div/div[2]/div[6]/div[1]/div/table/thead/tr/th[5]'))).click()
